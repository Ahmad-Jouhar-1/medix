...
class AppColors {
  ...
  static const Color transparentGreen = Color.fromARGB(128, 23, 184, 165);
  static const Color transparentYellow = Color(0x80FFC107);
  static const Color backgroundColor = Color(0xFFEEEEEE);
  static const Color widgetBackgroundColor = Color(0xFFF8F9FA);
